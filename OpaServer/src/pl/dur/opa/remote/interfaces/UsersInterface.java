...
public interface UsersInterface extends Remote
{
	...
	/**
	 * As a parameters it gets list of files to check if server contains files backuped.
	 * It returns the same list of files with added information if file is backuped.
	 * @param filesToCheck - list of files to chcek if they are backuped on server.
